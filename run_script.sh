...
for i in ${problems[@]}; do
	echo $i
	echo "begin-- $i" >> log2/output_$i.log
	echo "Timeout is $limit" >> log2/output_$i.log
	timeout --foreground -k 3 $limit swipl -q -s chr_shikaku.pl -t "solve($i)." &>> log2/output_$i.log
	echo "end-- $i" >> log2/output_$i.log
done